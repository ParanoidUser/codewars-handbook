...
class KataTests {
  ...
  void sample() {
    assertArrayEquals(new String[]{
        ...
        "Takeo",
        "Takao"
    }, Kata.lineupStudents("Tadashi Takahiro Takao Takashi Takayuki Takehiko Takeo Takeshi Takeshi"));
