...
class KataTest {
  ...
  void sample() {
    ...
    assertEquals("You are 365 days old", Kata.ageInDays(birthday.minusYears(1).getYear(), birthday.minusYears(1).getMonthValue(), birthday.minusYears(1).getDayOfMonth()));
  }
}
